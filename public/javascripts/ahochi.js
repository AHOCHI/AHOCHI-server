var app = angular.module('Ahochi', ['ngResource', 'ngRoute']);
...
app.controller('EditProviderCtrl', ['$scope', '$resource', '$location', '$routeParams',
	function($scope, $resource, $location, $routeParams){
		var Providers = $resource('/api/providers/:id', {id: '@_id' }, {
			update: { method: 'PUT' }
		});

		Providers.get({ id: $routeParams.id }, function(provider){
...
app.controller('DeleteProviderCtrl', ['$scope', '$resource', '$location', '$routeParams',
	function($scope, $resource, $location, $routeParams){
		...
		$scope.delete = function(){
			Providers.delete({ id: $routeParams.id }, function(provider){
				$location.path('/');
			});
		}
	}]);